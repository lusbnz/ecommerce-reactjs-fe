...
export const GET_SINGLE_PRODUCT_BEGIN = 'GET_SINGLE_PRODUCTS_BEGIN'
export const GET_SINGLE_PRODUCT_SUCCESS = 'GET_SINGLE_PRODUCTS_SUCCESS'
export const GET_SINGLE_PRODUCT_ERROR = 'GET_SINGLE_PRODUCTS_ERROR'
